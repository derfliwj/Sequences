...
def run_test_count_negatives():
    ...
    # Test 6:
    expected = 3
    actual = count_negatives((2, -26, 10, 67, -45, -86))
    print()
    ...
    # Test 7:
    expected = 4
    actual = count_negatives((-1, -54, -14, -9, 57, 65))
    print()
...
def run_test_count_short_ones():
    ...
    # Test 8:
    expected = 3
    seq = [[10, 20, 6, 8], [5, 6], [22, 45, 16, 18, 20, 38], [3], [8, 49, 16, 3, 25], [2, 10]]
    actual = count_short_ones(seq)
    print()
    ...
    # Test 9:
    expected = 5
    seq = [[10, 20, 6, 8], [5, 6], [], [22, 45, 16], [3], [8, 49, 16, 3, 25], [2, 10], []]
    actual = count_short_ones(seq)
    print()
