...
def run_test_count_items_bigger_than():
    ...
    # Test 9:
    sequence = [3, 120, 0, -42, -10, 76, -2, 13, 54]
    threshold = -1
    expected = 6
    actual = count_items_bigger_than(sequence, threshold)
    print()
    ...
    # Test 10:
    sequence = [-20, -84, 456, 21, 0, 100, 45, -23]
    threshold = 23
    expected = 3
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 1
    actual = count_positive_sines([4, 12, -2, 6, 12, 8])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 72
    actual = sum_first_n([23, 92, -43, 1], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 13
    actual = sum_first_n([76, -19, -32, -12, 8, 34], 4)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
